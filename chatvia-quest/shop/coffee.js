...
let sugar = document.getElementById("coffee_sugar")
...
function check1_click() {
    if(input_1.checked) {
        ...
        document.getElementById("coffee_type").innerHTML = "espresso"
        add.play()
        disable(input_2, input_3)
        if(input_4.checked || input_5.checked || input_6.checked) {
            $( "#submit" ).fadeIn( "5000")
        }
    } else {
        console.log("Input 1 is not checked")
        document.getElementById("coffee_type").innerHTML = "coffee"
        remove.play()
...
function check2_click() {
    if(input_2.checked) {
        ...
        document.getElementById("coffee_type").innerHTML = "cappuccino"
        add.play()
...
function check3_click() {
    if(input_3.checked) {
        ...
        document.getElementById("coffee_type").innerHTML = "french coffee"
        add.play()
  ...
  function submit_call() {
    ...
    setTimeout(function() {
        if(input_1.checked) {
            ...
            const product = "Cappuccino Coffee"
            if(input_4.checked) {
                const sugar = "Sugar Free"
                send(`${sugar} ${product}`)
            } else if(input_5.checked) {
