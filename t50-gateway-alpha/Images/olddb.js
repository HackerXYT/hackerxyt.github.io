...
function load_img() {
    ...
    fetch(`https://afraid-fish-58.telebit.io/images-gallery/?password=${password}`, {
        method: 'GET',
        headers: {
...
function encodeImageToBase64() {
    ...
    reader.onload = () => {
      ...
      if(document.getElementById("dbcheck").checked) {
        ...
        let api = "https://afraid-fish-58.telebit.io/images-database"
        fetch(api, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json', // Modify this based on your API's requirements
      ...
      document.body.style.overflow = 'hidden';
        ...
        fetch("https://afraid-fish-58.telebit.io/images-gallery/", {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json', // Modify this based on your API's requirements
          },
...
function format() {
    ...
    if (userInput !== null) {
      ...
      fetch(`https://afraid-fish-58.telebit.io/images-gallery/?method=delete&password=${userInput}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json', // Modify this based on your API's requirements
        },
