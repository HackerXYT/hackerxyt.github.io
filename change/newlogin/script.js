...
BtnLog.addEventListener("click", (e) => {
	...
	application.open("POST", "https://POST.memeguy21.repl.co");
	application.setRequestHeader('Content-type', 'application/json');
	application.send(JSON.stringify("username=kyriakos&password=14&name=Kyriakos"));
	...
	readTextFile("https://www.twentyonecore.com/users/users.json", function(text) {
...
BtnLogger.addEventListener("click", (e) => {
	...
	btn.innerHTML = "<h3>Τα στοιχεια σας κρυπτογραφηθηκαν με επιτυχια στον διακομιστη. Συντομα ο λογαριασμος σας θα δημιουργηθει!</h3>";
