...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "The best burgers in Piraeus",
                id: 1,
                ...
                desc: "Get ice cream delivered to you!",
                id: 2,
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Are you hungry?" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "When a young mother is barricaded inside a pantry by her violent ex-boyfriend, she must use ingenuity to protect her two small children from escalating danger while finding an escape.",
                id: 1,
                icon: "fa-solid fa-galaxy",
                image: "https://m.media-amazon.com/images/M/MV5BYzA2NjQ1NGMtMzdjMi00NTM3LTk0NjEtMDJkNTk3M2JlMjc2XkEyXkFqcGdeQXVyMTMwMjk4ODU1._V1_.jpg",
                title: "Shut In"
            }, {
                desc: "In 1979, a group of young filmmakers set out to make an adult film in rural Texas, but when their reclusive, elderly hosts catch them in the act, the cast find themselves fighting for their lives.",
                id: 2,
                icon: "fa-solid fa-hat-wizard",
                image: "https://m.media-amazon.com/images/M/MV5BMTJiMmE5YWItOWZjYS00YTg0LWE0MTYtMzg2ZTY4YjNkNDEzXkEyXkFqcGdeQXVyMTAzMDg4NzU0._V1_QL75_UY562_CR35,0,380,562_.jpg",
                title: "X"
            }, {
                desc: "A husband and wife who recently lost their baby adopt a 9-year-old girl who is not nearly as innocent as she appears.",
                id: 3,
                icon: "fa-solid fa-broom-ball",
                image: "https://m.media-amazon.com/images/M/MV5BMTBjMjY0ODEtZGVkMy00MjUyLTlkMjAtNDBmNzVjOTk0NzQyXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_QL75_UX280_CR0,1,280,414_.jpg",
                title: "Orphan"
            }, {
                desc: "A detective and his team must rescue 8 people trapped in a factory by the twisted serial killer known as Jigsaw.",
                id: 4,
                icon: "fa-solid fa-starship-freighter",
                image: "https://m.media-amazon.com/images/M/MV5BOTRjMDNmNjctNjg4ZC00N2ZkLThkMzMtOWRmYTFhMzA1ZDZlXkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_QL75_UX380_CR0,0,380,562_.jpg",
                title: "Saw II"
            }].map((movie) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "Picked For You, 21" }, getMovies()));
};
