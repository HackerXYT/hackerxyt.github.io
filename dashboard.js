...
checkProduct();
  ...
  setTimeout(function (){
    ...
    function updatenow() {
      document.getElementById("version_button").innerHTML = `<svg version="1.1" id="loader-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
