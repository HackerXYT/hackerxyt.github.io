...
//	fetch(`http://192.168.1.21:9000/setOffline?username=${localStorage.getItem("t50-username")}`)
//		.then(response => {
//			if (!response.ok) {
...
fetch(`http://192.168.1.21:9000/setOnline?username=${localStorage.getItem("t50-username")}`)
	.then(response => {
		if (!response.ok) {
			throw new Error(`HTTP error! Status: ${response.status}`);
		}
	...
	.then(data => {
		if (data === "200") {
			fetch(`http://192.168.1.21:9000/getOnlineUsers`)
				.then(response => {
					if (!response.ok) {
						throw new Error(`HTTP error! Status: ${response.status}`);
					}
...
function check_ccode(app) {
	...
	const url = `http://192.168.1.21:9000/accounts?applications=${app}&coupon=${coupon}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&username=${localStorage.getItem("t50-username")}`;
...
function pfp(give) {
	return new Promise((resolve, reject) => {
		...
		if (user != null) {
			...
			const url = `http://192.168.1.21:9000/profiles?authorize=351c3669b3760b20615808bdee568f33&pfp=${user}`;
			fetch(url)
...
function show_authip() {
	//ipv4-list
	fetch(`http://192.168.1.21:9000/authip?method=read&username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function disable2FA() {
	//disable 2fa
	fetch(`http://192.168.1.21:9000/authip?method=forceadd&email=${localStorage.getItem("t50-email")}&username=${localStorage.getItem("t50-username")}&password=${atob(localStorage.getItem("t50pswd"))}&ip=null`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function enable2FA() {
	fetch(`http://192.168.1.21:9000/authip?method=RemoveIP&username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&ip=null`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function acceptfriend(element) {
	...
	fetch(`http://192.168.1.21:9000/social?username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&todo=acceptRequest&who=${element.id}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function showFriend(element) {
	...
	$("#friends").fadeOut("fast", function () {
		fetch(`http://192.168.1.21:9000/accounts?email=${document.getElementById("friend-email").innerHTML}&username=${friend}&method=last_login`)
			.then(response => {
				if (!response.ok) {
					throw new Error(`HTTP error! Status: ${response.status}`);
				}
...
function show_friends() {
	...
	fetch(`http://192.168.1.21:9000/social?username=${localStorage.getItem("t50-username")}&todo=friends`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
		...
		.then(data => {
			...
			user_requests.forEach(username => {
				fetch(`http://192.168.1.21:9000/accounts?method=getemailbyusername&username=${username}`)
					.then(response => {
						if (!response.ok) {
							throw new Error(`HTTP error! Status: ${response.status}`);
						}
					...
					.then(profileemail => {
						...
						if (listContainer.querySelector(`#user-${username}-email`) === null) {
							...
							fetch(`http://192.168.1.21:9000/profiles?authorize=351c3669b3760b20615808bdee568f33&pfp=${username}`)
								.then(response => {
									if (!response.ok) {
										throw new Error(`HTTP error! Status: ${response.status}`);
									}
...
function show_requests() {
	...
	fetch(`http://192.168.1.21:9000/social?username=${localStorage.getItem("t50-username")}&todo=getRequests`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function addfriend(element) {
	...
	fetch(`http://192.168.1.21:9000/social?username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&todo=friendRequest&who=${element.id}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function loadusers() {
	let url = `http://192.168.1.21:9000/search?search=`;
						...
						fetch(`http://192.168.1.21:9000/accounts?method=getemailbyusername&username=${username}`)
							...
							.then(profileemail => {
								...
								if (listContainer.querySelector(`#user-${username}-email`) === null) {
									...
									fetch(`http://192.168.1.21:9000/social?username=${localStorage.getItem("t50-username")}&todo=sentRequests`)
										.then(response => {
											if (!response.ok) {
												throw new Error(`HTTP error! Status: ${response.status}`);
											}
...
function handlesearch(value) {
	...
	if (value.length < 0) {
		...
		let url = `http://192.168.1.21:9000/search?search=${value}`;
...
function handleFileSelect() {
	...
	if (file) {
		...
		reader.onload = function (e) {
			...
			fetch('http://192.168.1.21:9000/profiles', {
				method: 'POST',
				headers: {
...
function complete_chpswd() {
	...
	fetch('http://192.168.1.21:9000/accounts', {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
function clearNotifications() {
	...
	fetch(`http://192.168.1.21:9000/notifications?process=clear&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&username=${localStorage.getItem("t50-username")}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function show_notif(nosound) {
	fetch(`http://192.168.1.21:9000/notifications?process=get&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&username=${localStorage.getItem("t50-username")}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
		...
		.then(data => {
			...
			notifications.forEach(function (notification) {
				...
				if (!sentimage.includes("http")) {
					const url = `http://192.168.1.21:9000/profiles?authorize=351c3669b3760b20615808bdee568f33&pfp=${notification.image}`;
					fetch(url)
						.then(response => response.text())
						.then(data => {
							if (data.indexOf("base64") === -1) {
...
function confirm_ipremove() {
	...
	fetch(`http://192.168.1.21:9000/authip?method=RemoveIP&username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&ip=${ip}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function complete_birth() {
	...
	if (isNumber(day) && isNumber(month) && isNumber(year) && !isNaN(day) && !isNaN(month) && !isNaN(year)) {
		if (day > 0 && day <= 31 && month > 0 && month < 13 && year > 1899 && year < currentDate.getFullYear()) {
			...
			fetch(`http://192.168.1.21:9000/accounts?birth=true&username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}&what=${birthdate}`)
				.then(response => {
					if (!response.ok) {
						throw new Error(`HTTP error! Status: ${response.status}`);
					}
...
function getBirth() {
	fetch(`http://192.168.1.21:9000/accounts?birth=get&username=${localStorage.getItem("t50-username")}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function complete_addemail() {
	...
	fetch(`http://192.168.1.21:9000/accounts?method=addemail&newemail=${email}&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function verify_addemail() {
	...
	fetch(`http://192.168.1.21:9000/accounts?method=ver_new_email&email=${email}&what=${code}&mainemail=${localStorage.getItem("t50-email")}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function loademails() {
	fetch(`http://192.168.1.21:9000/accounts?method=getemails&email=${localStorage.getItem("t50-email")}&password=${atob(localStorage.getItem("t50pswd"))}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
...
function confirmRemoveEmail() {
	...
	fetch(`http://192.168.1.21:9000/accounts?method=removeemail&email=${emailtorem}&password=${atob(localStorage.getItem("t50pswd"))}&mainemail=${localStorage.getItem("t50-email")}`)
		.then(response => {
			if (!response.ok) {
				throw new Error(`HTTP error! Status: ${response.status}`);
			}
